...
pred_files = glob.glob(os.path.join(pred_folder, "predictions_*0.98.csv"))
...
output_file = f'/home/ubuntu/data/ML/results/OCEANIDS/metrics/{location}-metrics-0.98.csv'
